...
- [C3] <span style="background-color:rgb(0, 96, 193); color: #ffffff; padding: 1px 6px; border-radius: 3px; font-weight: bold;">DAC 2026</span> [LegoTherm: Modular and Reusable Thermal Model for Chiplet-based Heterogeneous Integration](https://dac.com/2026/accepted-paper-ids), **<u>Pengju Chen</u>**, Dan Niu, Depeng Xie, Gang Wang, Chen Wu, Wei W. Xing and Lei He. 2026 63rd ACM/IEEE Design Automation Conference (DAC), Long Beach, United States, 2026.
